...
root.title("Hệ thống điểm danh bằng khuôn mặt DEMO")
...
file.add_command(label ='Quản lý Admin', command = None)
file.add_command(label ='Quản lý Nhân Viên', command = None)
...
edit.add_command(label ='Sửa thông tin', command = None)
edit.add_command(label ='Thêm mới', command = None)
edit.add_command(label ='Xóa thống tin', command = None)
edit.add_separator()
edit.add_command(label ='Tìm nhân viên', command = None)
...
# INFO_EMPLOYEE = tk.StringVar()
# INFO_EMPLOYEE.set("Không phát hiện")
# message_label=tk.Label(root,textvariable=MESSAGE, wraplength = "5c", bg="white", fg="red")
# message_label.place(relx=0.97,rely=0.080,relwidth=0.2,relheight=0.16,anchor="ne")
# message_label.config(font=(None, 11))
